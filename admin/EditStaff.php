    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header"> Edit Staff
          </h1>
          <?php $page = "updateStaff.php?id=".$id; ?>
    			<form class="contact-form php-mail-form" role="form" method="POST" action=<?=$page?>>


            <div class="form-group">
              <label for="contact-name" style="color: #418BCA ;">Staff Name</label>
              <input type="name" name="name" class="form-control" id="contact-name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" value="<?=$row['Name']?>" required >
              <div class="validate"></div>
            </div>
            <div class="form-group">
              <label for="contact-email" style="color: #418BCA ;" >Staff Email</label>
              <input type="email" name="email" class="form-control" id="contact-email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" value="<?=$row['Email']?>" required>
              <div class="validate"></div>
            </div>
      ...
      <div class="form-group">
       ...
       <label class="control-label" style="color: #418BCA ;" >Choose Subject</label>
        ...
        <div class="form-group">
        <div ><br><br><center>
        <button  name="submit" type="submit" class="btn btn-primary"> SUBMIT <span class="glyphicon glyphicon-send"></span></button></center>
        </div>
        </div>
